...
class App(customtkinter.CTk):
    ...
    def add_car_test(self):
        ...
        self.output_car_button = customtkinter.CTkButton(master=self.add_car_frame, text="Add Car", command=successfully_add)
        self.output_car_button.grid(row=4, column=1, pady=15, padx=0)

    def search_car_test(self):

        def find_car():
            newSearch = Inventory(ctk_items[1][0].get(), ctk_items[1][1].get(), ctk_items[1][2].get(), ctk_items[1][3].get())
